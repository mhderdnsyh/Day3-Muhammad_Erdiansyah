...
public class Rumah_Sakit_Awal_Bross extends ListActivity {
    ...
    private void tampilkanpilihan(String pilihan) {
        try {
            ...
            if (pilihan.equals("Call Center")) {
                ...
                String smsText = "Muhammad Erdiansyah";
                a = new Intent(Intent.ACTION_VIEW);
                a.setData(Uri.parse("sms:081378012203"));
                a.putExtra("sms_body", smsText);
            }
            else if (pilihan.equals("Driving Direction")) {
                String lokasihospital = "google.navigation:q=0.4966966839735603, 101.45627726784552";
